"""Tests for the command injection scanner (command_injection).

Tests the injection scanner using synthetic ScanContext with mock sessions (unit).
Covers shell injection (CWE-78), argument injection (CWE-88), and path traversal
...
# ---------------------------------------------------------------------------
# Integration tests — shell injection fixture (skipped, requires fixture server)
# ---------------------------------------------------------------------------
