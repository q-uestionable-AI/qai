"""Tests for the supply chain scanner (supply_chain).

Tests the scanner with synthetic ScanContext and verifies detection of
unidentified servers, known CVEs, outdated protocol versions, and tool
namespace confusion.
