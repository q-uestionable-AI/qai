...
qai rxp validate --profile hr-policy --model sentence-transformers/all-mpnet-base-v2
```
...
Each profile lives in a subdirectory under `src/q_ai/rxp/profiles/` and contains:
