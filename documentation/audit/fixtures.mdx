---
title: Test Fixtures
description: Intentionally vulnerable MCP servers for scanner validation and testing
---

q-ai includes intentionally vulnerable MCP server fixtures for scanner validation, integration testing, and vulnerability demonstration. Each fixture contains one or more vulnerabilities mapped to the OWASP MCP Top 10.
