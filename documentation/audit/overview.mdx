...
<Note>
**Library capability.** Audit is not mounted on the root `ctpf` CLI. Use the
Python package API—not `ctpf audit`. The public CLI center is
[`ctpf proxy`](/proxy/overview).
</Note>
