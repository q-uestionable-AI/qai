...
[MITRE ATLAS](https://atlas.mitre.org/) (Adversarial Threat Landscape for AI Systems) is the adversarial machine learning threat matrix maintained by MITRE. It catalogs tactics and techniques observed in real-world attacks on AI systems. q-ai maps audit findings to technique-level ATLAS IDs, providing a cross-reference between MCP-specific vulnerabilities and the broader adversarial ML threat landscape.

See [Framework Coverage](/audit/framework-coverage) for the full ATLAS mapping table.
