...
The web dashboard shows live hit feed and historical campaign status. Access at `http://localhost:8080/ui/` while the listener is running.
...
The CLI output or web dashboard shows:
