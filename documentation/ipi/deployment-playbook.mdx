...
- **template_id** — Document context template used to frame the payload (see the [Template Catalog](/ipi/templates)); `—` for pre-migration runs created before the template system shipped
