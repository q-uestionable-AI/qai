...
The RXP module lives at `src/q_ai/rxp/` and implements a retrieval poisoning validation engine. It measures whether adversarial documents achieve retrieval rank in vector similarity searches across configurable embedding models.
