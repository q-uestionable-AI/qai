...
- **Rule ID** — Scanner rule identifier (e.g., `QAI-INJ-tool-parameter-injection`)
...
4. High/critical findings in SARIF cause the upload step to create error-level alerts, which can fail the check
