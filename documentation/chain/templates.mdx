...
<Note>
Only `audit` and `inject` are valid chain modules. CXP, IPI, RXP, and proxy cannot be used as chain steps — they operate outside the MCP tool interaction model that chains test.
</Note>
