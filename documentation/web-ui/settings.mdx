...
The Settings page manages LLM provider credentials, defaults, and MCP connection configuration. All settings persist in a local SQLite database with credentials stored securely in the OS keyring.
