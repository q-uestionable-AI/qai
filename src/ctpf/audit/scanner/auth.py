"""Authentication & Authorization scanner (auth).
...
logger = logging.getLogger("ctpf.audit.scanner.auth")
...
class AuthScanner(BaseScanner):
    """Scanner for authentication and authorization weaknesses.
    ...
    async def scan(self, context: ScanContext) -> list[ScanFinding]:
        ...
        Returns:
            List of ScanFindings for each authentication weakness detected.
        """
    ...
    def _check_unauth_enumeration(self, context: ScanContext) -> ScanFinding | None:
        ...
        Returns:
            A ScanFinding if unauthenticated enumeration succeeded, None otherwise.
        """
    ...
    async def _check_unauth_invocation(self, context: ScanContext) -> ScanFinding | None:
        ...
        Returns:
            A ScanFinding if unauthenticated invocation succeeded, None otherwise.
        """
    ...
    def _check_transport_encryption(self, context: ScanContext) -> ScanFinding | None:
        ...
        Returns:
            A ScanFinding if transport is unencrypted, None otherwise.
        """
        if context.transport_type == "stdio":
    ...
    def _check_default_port(self, context: ScanContext) -> ScanFinding | None:
        ...
        Returns:
            A ScanFinding if server uses a well-known MCP port, None otherwise.
        """
        if context.transport_type == "stdio":
            return None
