...
Planned Enhancement:
    ...
    This enhancement supports cross-tool advisory strategy for the
    CTPF security platform.
"""
...
# Planned enhancement: `ctpf update-cves` CLI command (GitHub Advisory Database
...
class SupplyChainScanner(BaseScanner):
    ...
    def _check_server_identity(self, context: ScanContext) -> list[ScanFinding]:
    ...
    def _check_known_cves(self, context: ScanContext) -> list[ScanFinding]:
    ...
    def _check_protocol_version(self, context: ScanContext) -> list[ScanFinding]:
    ...
    def _check_tool_namespaces(self, context: ScanContext) -> list[ScanFinding]:
