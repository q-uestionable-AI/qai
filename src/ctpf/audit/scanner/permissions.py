...
logger = logging.getLogger("ctpf.audit.scanner.permissions")
...
class PermissionsScanner(BaseScanner):
    ...
    def _check_excessive_tools(self, context: ScanContext) -> ScanFinding | None:
    ...
    def _check_dangerous_capabilities(self, context: ScanContext) -> list[ScanFinding]:
    ...
    def _check_unconstrained_params(self, context: ScanContext) -> list[ScanFinding]:
    ...
    def _check_write_ratio(self, context: ScanContext) -> ScanFinding | None:
