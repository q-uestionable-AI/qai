...
from q_ai.proxy.correlation import is_notification
...
from q_ai.proxy.tui.widgets.message_detail import MessageDetailPanel
from q_ai.proxy.tui.widgets.message_list import MessageListPanel, MessageSelected
from q_ai.proxy.tui.widgets.status_bar import ProxyStatusBar
...
class ProxyApp(App[None]):
    ...
    async def _replay_worker(
        ...
        """
        try:
            from q_ai.proxy.adapters.sse import SseServerAdapter as _SseAdapter
            from q_ai.proxy.adapters.stdio import (
