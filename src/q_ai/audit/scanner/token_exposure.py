...
Checks:
    QAI-TOK-001: Sensitive parameter names in tool schemas
    QAI-TOK-002: Secret patterns in tool responses
    QAI-TOK-003: Secrets in error responses
    QAI-TOK-004: Environment variable leakage
...
from q_ai.audit.scanner.base import (
    BaseScanner,
    ScanContext,
    ScanFinding,
    Severity,
...
logger = logging.getLogger("q_ai.audit.scanner.token_exposure")
