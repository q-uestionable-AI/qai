...
from q_ai.mcp.payloads.injection import InjectionPayload, get_injection_payloads

logger = logging.getLogger("q_ai.audit.scanner.injection")
...
class InjectionScanner(BaseScanner):
    ...
    def _detect_canary(
        ...
        if payload.canary and payload.canary in response_text:
            ...
            return ScanFinding(
                rule_id=f"QAI-INJ-{cwe}-{payload.technique}",
