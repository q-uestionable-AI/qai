...
def _generate_poc_readme(result: TestResult, technique: Technique) -> str:
...
*Generated by CTPF Research Harness CXP — https://github.com/q-uestionable-AI/CTPF*
"""
