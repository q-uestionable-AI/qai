...
logger = logging.getLogger("q_ai.mcp.discovery")
...
async def enumerate_server(conn: MCPConnection) -> ScanContext:
    ...
    info_dict: dict[str, Any] = {
        ...
        "capabilities": {
            attr: bool(capabilities and getattr(capabilities, attr, None) is not None)
            for attr in ("tools", "resources", "prompts", "logging")
        },
