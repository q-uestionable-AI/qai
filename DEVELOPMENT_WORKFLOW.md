...
A user cloning `main`, installing from PyPI, or reading docs should get a closely matching experience.
...
> If a user installs from PyPI, reads the docs, and checks out `main`, will those three experiences match closely enough?
...
10. Confirm docs match the released behavior.
